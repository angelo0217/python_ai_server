...
def show_usage_examples():
    ...
    print("python gemini_agents_enhanced.py --task_name web_scraper --temperature 0.4 --review_depth detailed")
    print("python gemini_agents_enhanced.py --task_name api_server --task_complexity advanced --rounds 3")
    
    print("\n使用自定義任務（將任務保存在文件中）：")
    print('python gemini_agents_enhanced.py --task "$(cat custom_task.txt)" --rounds 3 --review_depth detailed')
